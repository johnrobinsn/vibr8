  ...
  return (
    <div className="flex-1 h-full flex items-center justify-center px-3 sm:px-4">
      <div className="w-full max-w-2xl">
        {/* Logo + Title */}
        <div className="flex items-center justify-center gap-3 mb-4 sm:mb-6 text-4xl sm:text-5xl">
          <img src={logoSrc} alt="" className="h-[1em] w-auto" />
          <h1 className="font-semibold text-cc-fg">
            vibr8
          </h1>
        </div>
