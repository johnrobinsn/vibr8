...
- Move remaining hub-owned execution behavior behind node operations or delete it after parity. **Legacy launcher reconnect and session-registry startup sync are skipped in default self-node mode.**
