...
client address from `X-Forwarded-For` instead of the local tunnel/proxy
address. Only enable this when all direct access to vibr8 is blocked or
otherwise trusted; untrusted clients can forge forwarding headers.
